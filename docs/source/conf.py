...
# spaceflight_kedro documentation build
...
from spaceflight_kedro import __version__ as release

# -- Project information -----------------------------------------------------

project = "spaceflight_kedro"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "spaceflight_kedrodoc"
...
latex_documents = [
    (
        master_doc,
        "spaceflight_kedro.tex",
        "spaceflight_kedro Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "spaceflight_kedro",
        "Project spaceflight_kedro codebase.",
        "Data-Science",
    )
]
